                ...
                <div className="landing">
                    ...
                    <div className="landing__slots">
                        <div className="landing__pattern">
                            ...
                            <div><img className="landing__country" src="/images/bra.jpeg" alt="Country 04" /></div>
                        ...
                        <div className="landing__pattern">
                            ...
                            <div><img className="landing__country" src="/images/iri.jpeg" alt="Country 11" /></div>
                            <div><img className="landing__country" src="/images/jap.jpeg" alt="Country 17" /></div>
                        ...
                        <div className="landing__pattern">
                            <div><img className="landing__country" src="/images/nig.jpeg" alt="Country 11" /></div>
